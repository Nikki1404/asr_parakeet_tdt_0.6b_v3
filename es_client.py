...
{"error":{"message":"file: Field required","type":"BadRequestError"curl -X POST http://localhost:9000/v1/audio/transcriptions^C
(env) root@cx-asr-test:/home/re_nikitav/parakeet-asr-multilingual# python3 transcribe_parakeet_es_batch.py --ba
se-url http://localhost:9000 --input-folder /home/re_nikitav/audio_maria --output-folder /home/re_nikitav/parak
eet_es_results
TOTAL FILES = 15
STARTING -> maria1.mp3
...
(env) root@cx-asr-test:/home/re_nikitav/parakeet-asr-multilingual# vi transcribe_parakeet_es_batch.py 
(env) root@cx-asr-test:/home/re_nikitav/parakeet-asr-multilingual# python3 transcribe_parakeet_es_batch.py --ba
se-url http://localhost:9000 --input-folder /home/re_nikitav/audio_maria --output-folder /home/re_nikitav/parak
eet_es_results
TOTAL FILES = 15
