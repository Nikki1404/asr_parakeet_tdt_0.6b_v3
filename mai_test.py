...
curl.exe --location "https://eastus2.stt.speech.microsoft.com/speechtotext/transcriptions:transcribe?api-version=2025-10-15" --header "Ocp-Apim-Subscription-Key: YOUR_KEY" --form "audio=@C:/Users/YourName/Desktop/audio/english_file.wav" --form "definition={\"locales\":[\"en-US\"],\"enhancedMode\":{\"enabled\":true,\"model\":\"mai-transcribe-1\"}}"
